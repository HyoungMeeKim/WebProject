            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown" style="width:230px">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="productOther">Other Parts & Accessory</a></li>
                    </ul>
                </li>
                <li class="nav-item" style="width:230px">
                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <%
                            ...
                            ArrayList<Product> list = productDAO.showAllCity();
                            for (int i = 0; i < list.size(); i++) {
                        %>
                        <tr>
                            <td><%=(i + 1)%>
                            </td>
                            <td><%=list.get(i).getProductID()%>
                            </td>
                            <td><%=list.get(i).getProductName()%>
                            </td>
                            <td><%=list.get(i).getCategoryID()%>
                            </td>
